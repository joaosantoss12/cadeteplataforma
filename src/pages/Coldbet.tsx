...
export default function Coldbet() {
    ...
    <div className="space-y-12 animate-in fade-in duration-500 pb-16">
      ...
      <div className="space-y-6">
        <h2 className="text-3xl md:text-4xl font-black text-white text-center mb-8">
          Porquê escolher a <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">Coldbet</span>?
        </h2>
