...
const TELEGRAM_LINK = 'https://t.me/+SKORioP4thwyZGRk';

export default function TipsDaBruna() {
  return (
    <div className="space-y-10 animate-in fade-in duration-500 pb-16">
      ...
      <div className="border-b border-red-900/30 pb-6">
        <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight flex items-center gap-3 drop-shadow-lg">
          ...
          Tips da <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">Bruna</span>
        </h1>
        <p className="mt-3 text-blue-200/70 max-w-2xl text-lg">
          As entradas e análises da Bruna, direto para o grupo do Telegram. Acompanha as apostas e as jogadas escolhidas a dedo.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-red-700 to-orange-700 rounded-3xl p-1 shadow-[0_0_40px_rgba(239,68,68,0.25)]">
        <div className="bg-[#0a0202] rounded-[22px] p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="space-y-8">
              ...
              <div>
                <h2 className="text-4xl md:text-5xl font-black text-white mb-4 leading-tight">
                  Entra no grupo da <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-400">Bruna</span>
                </h2>
                <p className="text-blue-200/80 text-lg leading-relaxed">
                  Tips diretas, sem enrolação. Acompanha as escolhas e as entradas da Bruna assim que saem, direto no Telegram.
                </p>
              </div>
            ...
            {/* Direita: Imagem da Bruna */}
            <div className="relative rounded-2xl overflow-hidden border-2 border-red-500/30 shadow-2xl group h-full min-h-[400px]">
              <div className="absolute inset-0 bg-gradient-to-t from-[#0a0202] via-[#0a0202]/40 to-transparent opacity-90 z-10 transition-opacity group-hover:opacity-70"></div>
              <img
                src="/bruna.jpg"
                alt="Tips da Bruna"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#160404] border border-red-900/40 rounded-2xl p-6 hover:border-red-500/50 transition-all group">
            ...
            <p className="text-blue-200/70 text-sm leading-relaxed">
              Entradas disparadas assim que a Bruna encontra a oportunidade. És dos primeiros a saber.
            </p>
          </div>
          ...
          <div className="bg-[#160404] border border-red-900/40 rounded-2xl p-6 hover:border-red-500/50 transition-all group">
            ...
            <p className="text-blue-200/70 text-sm leading-relaxed">
              Informação direta, sem filtros, do olhar atento da Bruna sobre os jogos do dia.
            </p>
          </div>
        </div>
      </div>
